...
<?php else: ?>
    ...
    <div class="header w1210 bc mt15">
        ...
        <div class="nav w1210 bc mt10">
            ...
            <?php if(CONTROLLER_NAME== 'Index' and ACTION_NAME== 'index'): ?><!--首页：展开-->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo C('SITE_URL'); echo ($picsinfo[0]["pics_big"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo C('SITE_URL'); echo ($picsinfo[0]["pics_mid"]); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
<?php if(is_array($picsinfo)): foreach($picsinfo as $k=>$v): if(($k) == "0"): ?><li class="cur"><a class="zoomThumbActive"
<?php else: ?>
	<li><a<?php endif; ?>
...
<ul>
	...
	<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					...
					<form action="" method="post" class="choose">
						<ul>
<?php if(is_array($muchattr)): foreach($muchattr as $key=>$v): ?><li class="product">
	<dl>
		<dt><?php echo ($v["attr_name"]); ?>：</dt>
		<dd>
			<?php if(is_array($v["values"])): foreach($v["values"] as $kk=>$vv): if(($kk) == "0"): ?><a class="selected" href="javascript:;"><?php echo ($vv); ?> <input type="radio" name="color" value="<?php echo ($vv); ?>" checked="checked" /></a>
			<?php else: ?>
...
function add_cart(goods_id){
	$.ajax({
		url:"<?php echo U('Shop/addCart');?>",  //模板中可以通过U()函数设置请求地址
		//url:"/index.php/Home/Shop/addCart",//在纯js文件中就需要通过“绝对路径"方式设置请求地址
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
<?php if(is_array($singleattr)): foreach($singleattr as $key=>$v): ?><li><span><?php echo ($v["attr_name"]); ?>：</span><?php echo ($v["attr_value"]); ?></li><?php endforeach; endif; ?>
