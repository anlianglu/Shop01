...
<div class="login w990 bc mt10">
	...
	<div class="login_bd">
		<div class="login_form fl">
			<form action="/shop1234/index.php/Home/User/login.html" method="post">
				<ul>
					<li>
						<label for="">用户名：</label>
...
{
    childWindow = window.open("/Common/Plugin/qq/oauth/qq_login.php","TencentLogin","width=450,height=320,menubar=0,scrollbars=1, resizable=1,status=1,titlebar=0,toolbar=0,location=1");
} 
</script>
			<div class="coagent mt15">
				<dl>
					<dt>使用合作网站登录商城：</dt>
					<dd class="qq"><a href="javascript:void()" onclick='toQzoneLogin()'><span></span>QQ</a></dd>
